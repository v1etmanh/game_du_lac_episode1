...
function StartPage(props) {
  ...
  if (props.puzzle && props.puzzle.length) {
    for (let i = 0; i < props.puzzle.length; i += 1) {
  ...
  return (
    <div className="background-startpage">
        ...
        <Col size="md-8">
          <div className="info-card">
            <div className="card-body">
              ...
              <br />
              <p className="card-text">ESCAPE! Before it's too late!</p>
              <div className="startBtn">
                <button type="button" className="start" onClick={() => props.navigate("office")}>
                  {count > 0 ? "RESUME" : "START GAME"}
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="night-background">
        ...
        <div className="forest-background-start" />
        <div className="road" />
      </div>
    </div>
  );
